...
NzButtonComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: NzButtonComponent, selectors: [["button", "nz-button", ""], ["a", "nz-button", ""]], contentQueries: function NzButtonComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, icon.NzIconDirective, 5, core.ElementRef);
    } if (rf & 2) {
        var _t;
...
NzButtonModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[bidi.BidiModule, common.CommonModule, wave.NzWaveModule, icon.NzIconModule, transitionPatch.ɵNzTransitionPatchModule], ɵngcc5.ɵNzTransitionPatchModule, ɵngcc6.NzWaveModule] });
