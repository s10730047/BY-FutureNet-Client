...
export declare class NzPageHeaderComponent implements AfterViewInit, OnDestroy, OnInit {
    ...
    ngOnDestroy(): void;
    getBackIcon(): string;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NzPageHeaderComponent, [{ optional: true; }, null, null, null, null, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NzPageHeaderComponent, "nz-page-header", ["nzPageHeader"], { "nzBackIcon": "nzBackIcon"; "nzGhost": "nzGhost"; "nzTitle": "nzTitle"; "nzSubtitle": "nzSubtitle"; }, { "nzBack": "nzBack"; }, ["nzPageHeaderFooter", "nzPageHeaderBreadcrumb"], ["nz-breadcrumb[nz-page-header-breadcrumb]", "nz-avatar[nz-page-header-avatar]", "nz-page-header-title, [nz-page-header-title]", "nz-page-header-subtitle, [nz-page-header-subtitle]", "nz-page-header-tags, [nz-page-header-tags]", "nz-page-header-extra, [nz-page-header-extra]", "nz-page-header-content, [nz-page-header-content]", "nz-page-header-footer, [nz-page-header-footer]"]>;
}
