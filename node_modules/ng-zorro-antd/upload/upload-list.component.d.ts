...
export declare class NzUploadListComponent implements OnChanges {
    ...
    detectChanges(): void;
    ngOnChanges(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NzUploadListComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NzUploadListComponent, "nz-upload-list", ["nzUploadList"], { "locale": "locale"; "iconRender": "iconRender"; "dir": "dir"; "items": "items"; "listType": "listType"; "icons": "icons"; "onPreview": "onPreview"; "onRemove": "onRemove"; "onDownload": "onDownload"; "previewFile": "previewFile"; "previewIsImage": "previewIsImage"; }, {}, never, never>;
}
export {};
